package net.oussamaTp.accountservice;

import net.oussamaTp.accountservice.clients.CustomerRestClient;
import net.oussamaTp.accountservice.entities.BankAccount;
import net.oussamaTp.accountservice.enums.AccountType;
import net.oussamaTp.accountservice.repository.BankAccountRepository;
